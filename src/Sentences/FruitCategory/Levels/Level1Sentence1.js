...
const optionsList = ["Aardbei", "Ren", "Appel", "Banaan"];
const correctAnswer = "Ren";

const Level1Sentence1 = () => {
    ...
    <div>
      <div className="container">
        ...
        <div className="footer">
          {answeredCorrectly ? (
            <Link
              to="/Sentences/Fruit-Category/Levels/Level-1-sentence-2"
...
export default Level1Sentence1;
