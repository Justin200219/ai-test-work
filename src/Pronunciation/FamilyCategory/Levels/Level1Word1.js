    ...
    <div className="container">
      ...
      <main className="content">
        ...
        <div className="image-container">
          <img src="/images/ChatGPT Image Apr 23, 2025, 11_38_03 AM.svg" alt="Orange" />
        </div>
        <div className="word">
          Sinaasappel <span className="translation">(Orange)</span>
        </div>
        <div className="phonetic">sie·naas·appel</div>
      </main>
      <div className="footer">
        <button className="btn listen-btn" id="listenBtn">
          <img src="/images/brand_awareness.svg" alt="" />Listen
        </button>
        <audio id="audioPlayer" src="/word-sounds/Sinaasappel (1).mp3"></audio>
        <Link to="/Pronunciation/Family-Category/Levels/Level-1-word-2" className="btn next-btn">Next</Link>
      </div>
    </div>
  );
};
